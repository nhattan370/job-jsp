       ...
       <%--  <sec:authorize access="isAuthenticated()">
		...
		<sec:authorize access="isAuthenticated()">
		    <li class="nav-item dropdown">
		        ...
		        <div class="dropdown-menu dropdown-menu-right shadow border-0" aria-labelledby="navbarDropdown" style="min-width: 200px;">
		            ...
		            <sec:authorize access="hasAuthority('USER')">
		                <a class="dropdown-item" href="${pageContext.request.contextPath}/user/save-job">Công việc đã lưu</a>
